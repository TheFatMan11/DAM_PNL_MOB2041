...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tb_thanhVien = "CREATE TABLE tb_thanhVien (     id_thanhvien INTEGER PRIMARY KEY AUTOINCREMENT,     hoten        TEXT,     diachi       TEXT,     email        TEXT    UNIQUE ,cccd TEXT );";
        ...
        String tb_phieuMuon="CREATE TABLE tb_phieuMuon (     sophieu      INTEGER PRIMARY KEY AUTOINCREMENT,     id_thanhvien INTEGER REFERENCES tb_thanhVien (id_thanhvien) ON DELETE CASCADE                                                                 ON UPDATE CASCADE,     id_thuThu    TEXT REFERENCES tb_thuThu (id_thuThu),     id_sach      INTEGER REFERENCES tb_sach (id_sach) ON DELETE CASCADE                                                       ON UPDATE CASCADE,     ngayMuon     TEXT,     ngayTra      TEXT,     trangThai    INTEGER DEFAULT (0) );";
